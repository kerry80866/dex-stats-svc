...
const (
	...
	IngestQueryService_QueryTopTokenAccountsByToken_FullMethodName = "/pb.IngestQueryService/QueryTopTokenAccountsByToken"
...
type IngestQueryServiceClient interface {
	...
	QueryTopTokenAccountsByToken(ctx context.Context, in *TokenTopReq, opts ...grpc.CallOption) (*BalanceResp, error)
...
func (c *ingestQueryServiceClient) QueryTopTokenAccountsByToken(ctx context.Context, in *TokenTopReq, opts ...grpc.CallOption) (*BalanceResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BalanceResp)
	err := c.cc.Invoke(ctx, IngestQueryService_QueryTopTokenAccountsByToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IngestQueryServiceServer interface {
	...
	QueryTopTokenAccountsByToken(context.Context, *TokenTopReq) (*BalanceResp, error)
...
func (UnimplementedIngestQueryServiceServer) QueryTopTokenAccountsByToken(context.Context, *TokenTopReq) (*BalanceResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryTopTokenAccountsByToken not implemented")
}
...
func _IngestQueryService_QueryTopTokenAccountsByToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TokenTopReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngestQueryServiceServer).QueryTopTokenAccountsByToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestQueryService_QueryTopTokenAccountsByToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestQueryServiceServer).QueryTopTokenAccountsByToken(ctx, req.(*TokenTopReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IngestQueryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryTopTokenAccountsByToken",
			Handler:    _IngestQueryService_QueryTopTokenAccountsByToken_Handler,
		},
		{
