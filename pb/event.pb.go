...
const (
	...
	EventType_TOKEN_HOLDER_CHANGE EventType = 12
	// --- 系统/同步类事件（编号从 60 开始） ---
...
// block_number级别的事件数组（封装一个 block_number 的全部事件）
type Events struct {
	...
	BlockNumber   uint64                 `protobuf:"varint,3,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"` // 所属 block_number
	Source        int32                  `protobuf:"varint,4,opt,name=source,proto3" json:"source,omitempty"`                              // 数据来源：1=GRPC推送，2=RPC补块
	...
	BlockTime     int64                  `protobuf:"varint,8,opt,name=block_time,json=blockTime,proto3" json:"block_time,omitempty"`       // 区块时间（Unix 秒）
...
func (x *Events) GetBlockTime() int64 {
	if x != nil {
		return x.BlockTime
	}
	return 0
...
func (x *Event) GetHolderChange() *TokenHolderChangeEvent {
	if x != nil {
		if x, ok := x.Event.(*Event_HolderChange); ok {
			return x.HolderChange
		}
	}
	return nil
}
...
type Event_HolderChange struct {
	HolderChange *TokenHolderChangeEvent `protobuf:"bytes,9,opt,name=holder_change,json=holderChange,proto3,oneof"`
}
...
func (*Event_HolderChange) isEvent_Event() {}
...
type TradeEvent struct {
	...
	EventId           uint64                 `protobuf:"varint,2,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`             // 事件唯一ID（block_number << 32 | log_index）
	BlockNumber       uint64                 `protobuf:"varint,3,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"` // 区块 block_number
	...
	TokenAmount       string                 `protobuf:"bytes,12,opt,name=token_amount,json=tokenAmount,proto3" json:"token_amount,omitempty"`                     // base token 实际成交数量（原生最小单位）
	QuoteTokenAmount  string                 `protobuf:"bytes,13,opt,name=quote_token_amount,json=quoteTokenAmount,proto3" json:"quote_token_amount,omitempty"`    // quote token 实际成交数量（原生最小单位）
	...
	PairTokenBalance  string                 `protobuf:"bytes,20,opt,name=pair_token_balance,json=pairTokenBalance,proto3" json:"pair_token_balance,omitempty"`    // 交易后池子base token余额
	PairQuoteBalance  string                 `protobuf:"bytes,21,opt,name=pair_quote_balance,json=pairQuoteBalance,proto3" json:"pair_quote_balance,omitempty"`    // 交易后池子quote token余额
	UserTokenBalance  string                 `protobuf:"bytes,22,opt,name=user_token_balance,json=userTokenBalance,proto3" json:"user_token_balance,omitempty"`    // 交易后用户base token余额
	UserQuoteBalance  string                 `protobuf:"bytes,23,opt,name=user_quote_balance,json=userQuoteBalance,proto3" json:"user_quote_balance,omitempty"`    // 交易后用户quote token余额
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *TradeEvent) GetQuoteTokenAmount() string {
	if x != nil {
...
func (x *TradeEvent) GetPairTokenBalance() string {
	if x != nil {
...
func (x *TradeEvent) GetPairQuoteBalance() string {
	if x != nil {
...
func (x *TradeEvent) GetUserTokenBalance() string {
	if x != nil {
...
func (x *TradeEvent) GetUserQuoteBalance() string {
	if x != nil {
...
type TransferEvent struct {
	...
	Amount           string                 `protobuf:"bytes,12,opt,name=amount,proto3" json:"amount,omitempty"`                                               // 转账数量（原生单位）
	Decimals         uint32                 `protobuf:"varint,13,opt,name=decimals,proto3" json:"decimals,omitempty"`                                          // token 精度
	SrcTokenBalance  string                 `protobuf:"bytes,14,opt,name=src_token_balance,json=srcTokenBalance,proto3" json:"src_token_balance,omitempty"`    // 转账后，来源账户余额
	DestTokenBalance string                 `protobuf:"bytes,15,opt,name=dest_token_balance,json=destTokenBalance,proto3" json:"dest_token_balance,omitempty"` // 转账后，目标账户余额
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *TransferEvent) GetSrcTokenBalance() string {
	if x != nil {
...
func (x *TransferEvent) GetDestTokenBalance() string {
	if x != nil {
...
type LiquidityEvent struct {
	...
	EventId                uint64                 `protobuf:"varint,2,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`                                                           // 事件唯一ID（block_number << 32 | log_index）
	BlockNumber            uint64                 `protobuf:"varint,3,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"`                                               // 区块 block_number 高度
	...
	TokenAmount            string                 `protobuf:"bytes,11,opt,name=token_amount,json=tokenAmount,proto3" json:"token_amount,omitempty"`                                               // token 添加/移除的数量（base token）
	QuoteTokenAmount       string                 `protobuf:"bytes,12,opt,name=quote_token_amount,json=quoteTokenAmount,proto3" json:"quote_token_amount,omitempty"`                              // quote token 添加/移除的数量
	...
	PairTokenBalance       string                 `protobuf:"bytes,20,opt,name=pair_token_balance,json=pairTokenBalance,proto3" json:"pair_token_balance,omitempty"`                              // 当前池子中 token 的余额（base token）
	PairQuoteBalance       string                 `protobuf:"bytes,21,opt,name=pair_quote_balance,json=pairQuoteBalance,proto3" json:"pair_quote_balance,omitempty"`                              // 当前池子中 quote token 的余额
	UserTokenBalance       string                 `protobuf:"bytes,22,opt,name=user_token_balance,json=userTokenBalance,proto3" json:"user_token_balance,omitempty"`                              // 用户 token 的余额（base token）
	UserQuoteBalance       string                 `protobuf:"bytes,23,opt,name=user_quote_balance,json=userQuoteBalance,proto3" json:"user_quote_balance,omitempty"`                              // 用户 quote token 的余额
...
func (x *LiquidityEvent) GetTokenAmount() string {
	if x != nil {
		return x.TokenAmount
	}
	return ""
...
func (x *LiquidityEvent) GetQuoteTokenAmount() string {
	if x != nil {
		return x.QuoteTokenAmount
	}
	return ""
...
func (x *LiquidityEvent) GetPairTokenBalance() string {
	if x != nil {
		return x.PairTokenBalance
	}
	return ""
...
func (x *LiquidityEvent) GetPairQuoteBalance() string {
	if x != nil {
		return x.PairQuoteBalance
	}
	return ""
...
func (x *LiquidityEvent) GetUserTokenBalance() string {
	if x != nil {
		return x.UserTokenBalance
	}
	return ""
...
func (x *LiquidityEvent) GetUserQuoteBalance() string {
	if x != nil {
		return x.UserQuoteBalance
	}
	return ""
...
type MintToEvent struct {
	...
	Amount         string                 `protobuf:"bytes,10,opt,name=amount,proto3" json:"amount,omitempty"`                                         // 铸造的数量（原生单位）
	Decimals       uint32                 `protobuf:"varint,11,opt,name=decimals,proto3" json:"decimals,omitempty"`                                    // token 精度
	ToTokenBalance string                 `protobuf:"bytes,12,opt,name=to_token_balance,json=toTokenBalance,proto3" json:"to_token_balance,omitempty"` // 铸造后的 token account 余额
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MintToEvent) GetBlockNumber() uint64 {
	if x != nil {
		return x.BlockNumber
	}
	return 0
...
func (x *MintToEvent) GetAmount() string {
	if x != nil {
		return x.Amount
	}
	return ""
...
func (x *MintToEvent) GetToTokenBalance() string {
	if x != nil {
...
type BurnEvent struct {
	...
	Amount           string                 `protobuf:"bytes,10,opt,name=amount,proto3" json:"amount,omitempty"`                                               // 被销毁的数量（原生单位）
	Decimals         uint32                 `protobuf:"varint,11,opt,name=decimals,proto3" json:"decimals,omitempty"`                                          // token 精度
	FromTokenBalance string                 `protobuf:"bytes,12,opt,name=from_token_balance,json=fromTokenBalance,proto3" json:"from_token_balance,omitempty"` // 销毁后的 token account 余额
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *BurnEvent) GetBlockNumber() uint64 {
	if x != nil {
		return x.BlockNumber
	}
	return 0
...
func (x *BurnEvent) GetAmount() string {
	if x != nil {
		return x.Amount
	}
	return ""
...
func (x *BurnEvent) GetFromTokenBalance() string {
	if x != nil {
...
// Token 持有人变化事件
type TokenHolderChangeEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          EventType              `protobuf:"varint,1,opt,name=type,proto3,enum=pb.EventType" json:"type,omitempty"`                // 事件类型（HOLDER_CHANGE）
	BlockNumber   uint64                 `protobuf:"varint,2,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"` // 区块 block_number
	BlockTime     int64                  `protobuf:"varint,3,opt,name=block_time,json=blockTime,proto3" json:"block_time,omitempty"`       // 区块时间（Unix 秒）
	HolderChange  []*TokenHolderChange   `protobuf:"bytes,4,rep,name=holder_change,json=holderChange,proto3" json:"holder_change,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TokenHolderChangeEvent) Reset() {
	*x = TokenHolderChangeEvent{}
	mi := &file_event_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TokenHolderChangeEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenHolderChangeEvent) ProtoMessage() {}

func (x *TokenHolderChangeEvent) ProtoReflect() protoreflect.Message {
	mi := &file_event_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenHolderChangeEvent.ProtoReflect.Descriptor instead.
func (*TokenHolderChangeEvent) Descriptor() ([]byte, []int) {
	return file_event_proto_rawDescGZIP(), []int{8}
}

func (x *TokenHolderChangeEvent) GetType() EventType {
	if x != nil {
		return x.Type
	}
	return EventType_UNKNOWN
...
func (x *TokenHolderChangeEvent) GetBlockNumber() uint64 {
	if x != nil {
		return x.BlockNumber
	}
	return 0
...
func (x *TokenHolderChangeEvent) GetBlockTime() int64 {
	if x != nil {
		return x.BlockTime
	}
	return 0
...
func (x *TokenHolderChangeEvent) GetHolderChange() []*TokenHolderChange {
	if x != nil {
		return x.HolderChange
	}
	return nil
...
type TokenHolderChange struct {
	...
	HolderDelta   int32                  `protobuf:"varint,2,opt,name=holder_delta,json=holderDelta,proto3" json:"holder_delta,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TokenHolderChange) Reset() {
	*x = TokenHolderChange{}
...
func (x *TokenHolderChange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenHolderChange) ProtoMessage() {}

func (x *TokenHolderChange) ProtoReflect() protoreflect.Message {
	mi := &file_event_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenHolderChange.ProtoReflect.Descriptor instead.
func (*TokenHolderChange) Descriptor() ([]byte, []int) {
	return file_event_proto_rawDescGZIP(), []int{9}
}

func (x *TokenHolderChange) GetToken() []byte {
	if x != nil {
		return x.Token
	}
	return nil
...
func (x *TokenHolderChange) GetHolderDelta() int32 {
	if x != nil {
		return x.HolderDelta
	}
	return 0
}
...
type BalanceUpdateEvent struct {
	...
	PreBalance    string                 `protobuf:"bytes,8,opt,name=pre_balance,json=preBalance,proto3" json:"pre_balance,omitempty"`     // 变更前余额
	PostBalance   string                 `protobuf:"bytes,9,opt,name=post_balance,json=postBalance,proto3" json:"post_balance,omitempty"`  // 变更后余额
...
func (x *BalanceUpdateEvent) GetBlockNumber() uint64 {
	if x != nil {
		return x.BlockNumber
	}
	return 0
...
func (x *BalanceUpdateEvent) GetPreBalance() string {
	if x != nil {
		return x.PreBalance
	}
	return ""
...
func (x *BalanceUpdateEvent) GetPostBalance() string {
	if x != nil {
...
type MigrateEvent struct {
	...
	EventId                    uint64                 `protobuf:"varint,2,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`                                                                // 事件唯一 ID（block_number << 32 | log_index）
	BlockNumber                uint64                 `protobuf:"varint,3,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"`                                                    // 区块高度
	...
	TokenAmount                string                 `protobuf:"bytes,13,opt,name=token_amount,json=tokenAmount,proto3" json:"token_amount,omitempty"`                                                    // base token 数量
	QuoteTokenAmount           string                 `protobuf:"bytes,14,opt,name=quote_token_amount,json=quoteTokenAmount,proto3" json:"quote_token_amount,omitempty"`                                   // quote token 数量
	MigrationFee               string                 `protobuf:"bytes,15,opt,name=migration_fee,json=migrationFee,proto3" json:"migration_fee,omitempty"`                                                 // 迁移手续费
	...
	SrcPairTokenBalance        string                 `protobuf:"bytes,29,opt,name=src_pair_token_balance,json=srcPairTokenBalance,proto3" json:"src_pair_token_balance,omitempty"`                        // 来源池 base token 余额
	SrcPairQuoteBalance        string                 `protobuf:"bytes,30,opt,name=src_pair_quote_balance,json=srcPairQuoteBalance,proto3" json:"src_pair_quote_balance,omitempty"`                        // 来源池 quote token 余额
	DestPairTokenBalance       string                 `protobuf:"bytes,31,opt,name=dest_pair_token_balance,json=destPairTokenBalance,proto3" json:"dest_pair_token_balance,omitempty"`                     // 目标池 base token 余额
	DestPairQuoteBalance       string                 `protobuf:"bytes,32,opt,name=dest_pair_quote_balance,json=destPairQuoteBalance,proto3" json:"dest_pair_quote_balance,omitempty"`                     // 目标池 quote token 余额
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *MigrateEvent) GetBlockNumber() uint64 {
	if x != nil {
		return x.BlockNumber
	}
	return 0
...
func (x *MigrateEvent) GetTokenAmount() string {
	if x != nil {
		return x.TokenAmount
	}
	return ""
...
func (x *MigrateEvent) GetQuoteTokenAmount() string {
	if x != nil {
		return x.QuoteTokenAmount
	}
	return ""
...
func (x *MigrateEvent) GetMigrationFee() string {
	if x != nil {
...
func (x *MigrateEvent) GetSrcPairTokenBalance() string {
	if x != nil {
...
func (x *MigrateEvent) GetSrcPairQuoteBalance() string {
	if x != nil {
...
func (x *MigrateEvent) GetDestPairTokenBalance() string {
	if x != nil {
...
func (x *MigrateEvent) GetDestPairQuoteBalance() string {
	if x != nil {
...
type LaunchpadTokenEvent struct {
	...
	TotalSupply   string                 `protobuf:"bytes,11,opt,name=total_supply,json=totalSupply,proto3" json:"total_supply,omitempty"`                              // 初始总发行量
...
func (x *LaunchpadTokenEvent) GetBlockNumber() uint64 {
	if x != nil {
		return x.BlockNumber
	}
	return 0
...
func (x *LaunchpadTokenEvent) GetTotalSupply() string {
	if x != nil {
...
const file_event_proto_rawDesc = "" +
	"\n" +
	"\vevent.proto\x12\x02pb\"\x8c\x02\n" +
	"\x06Events\x12\x18\n" +
	...
	"\fquote_prices\x18\a \x03(\v2\x0e.pb.TokenPriceR\vquotePrices\x12\x1d\n" +
	"\n" +
	"block_time\x18\b \x01(\x03R\tblockTime\"T\n" +
	"\n" +
	"TokenPrice\x12\x14\n" +
	"\x05token\x18\x01 \x01(\fR\x05token\x12\x14\n" +
	"\x05price\x18\x02 \x01(\x01R\x05price\x12\x1a\n" +
	"\bdecimals\x18\x03 \x01(\rR\bdecimals\"\xbf\x03\n" +
	"\x05Event\x12&\n" +
	...
	"\x05token\x18\b \x01(\v2\x17.pb.LaunchpadTokenEventH\x00R\x05token\x12A\n" +
	"\rholder_change\x18\t \x01(\v2\x1a.pb.TokenHolderChangeEventH\x00R\fholderChangeB\a\n" +
	"\x05event\"\xb4\x06\n" +
	"\n" +
	"TradeEvent\x12!\n" +
	...
	"\ftoken_amount\x18\f \x01(\tR\vtokenAmount\x12,\n" +
	"\x12quote_token_amount\x18\r \x01(\tR\x10quoteTokenAmount\x12\x14\n" +
	...
	"userWallet\x12,\n" +
	"\x12pair_token_balance\x18\x14 \x01(\tR\x10pairTokenBalance\x12,\n" +
	"\x12pair_quote_balance\x18\x15 \x01(\tR\x10pairQuoteBalance\x12,\n" +
	"\x12user_token_balance\x18\x16 \x01(\tR\x10userTokenBalance\x12,\n" +
	"\x12user_quote_balance\x18\x17 \x01(\tR\x10userQuoteBalance\"\xea\x03\n" +
	"\rTransferEvent\x12!\n" +
	"\x04type\x18\x01 \x01(\x0e2\r.pb.EventTypeR\x04type\x12\x19\n" +
	"\bevent_id\x18\x02 \x01(\x04R\aeventId\x12!\n" +
	"\fblock_number\x18\x03 \x01(\x04R\vblockNumber\x12\x1d\n" +
	...
	"destWallet\x12\x16\n" +
	"\x06amount\x18\f \x01(\tR\x06amount\x12\x1a\n" +
	"\bdecimals\x18\r \x01(\rR\bdecimals\x12*\n" +
	"\x11src_token_balance\x18\x0e \x01(\tR\x0fsrcTokenBalance\x12,\n" +
	"\x12dest_token_balance\x18\x0f \x01(\tR\x10destTokenBalance\"\xe8\a\n" +
	...
	"\x03dex\x18\n" +
	" \x01(\rR\x03dex\x12!\n" +
	"\ftoken_amount\x18\v \x01(\tR\vtokenAmount\x12,\n" +
	"\x12quote_token_amount\x18\f \x01(\tR\x10quoteTokenAmount\x12\x14\n" +
	...
	"\x12pair_quote_balance\x18\x15 \x01(\tR\x10pairQuoteBalance\x12,\n" +
	"\x12user_token_balance\x18\x16 \x01(\tR\x10userTokenBalance\x12,\n" +
	"\x12user_quote_balance\x18\x17 \x01(\tR\x10userQuoteBalance\x129\n" +
	"\rtoken_program\x18\x18 \x01(\x0e2\x14.pb.TokenProgramTypeR\ftokenProgram\x12D\n" +
	"\x13quote_token_program\x18\x19 \x01(\x0e2\x14.pb.TokenProgramTypeR\x11quoteTokenProgram\"\xfd\x02\n" +
	"\vMintToEvent\x12!\n" +
	"\x04type\x18\x01 \x01(\x0e2\r.pb.EventTypeR\x04type\x12\x19\n" +
	"\bevent_id\x18\x02 \x01(\x04R\aeventId\x12!\n" +
	"\fblock_number\x18\x03 \x01(\x04R\vblockNumber\x12\x1d\n" +
	...
	"\x10to_token_balance\x18\f \x01(\tR\x0etoTokenBalance\"\x87\x03\n" +
	"\tBurnEvent\x12!\n" +
	"\x04type\x18\x01 \x01(\x0e2\r.pb.EventTypeR\x04type\x12\x19\n" +
	"\bevent_id\x18\x02 \x01(\x04R\aeventId\x12!\n" +
	"\fblock_number\x18\x03 \x01(\x04R\vblockNumber\x12\x1d\n" +
	...
	" \x01(\tR\x06amount\x12\x1a\n" +
	"\bdecimals\x18\v \x01(\rR\bdecimals\x12,\n" +
	"\x12from_token_balance\x18\f \x01(\tR\x10fromTokenBalance\"\xb9\x01\n" +
	"\x16TokenHolderChangeEvent\x12!\n" +
	"\x04type\x18\x01 \x01(\x0e2\r.pb.EventTypeR\x04type\x12!\n" +
	"\fblock_number\x18\x02 \x01(\x04R\vblockNumber\x12\x1d\n" +
	"\n" +
	"block_time\x18\x03 \x01(\x03R\tblockTime\x12:\n" +
	"\rholder_change\x18\x04 \x03(\v2\x15.pb.TokenHolderChangeR\fholderChange\"L\n" +
	"\x11TokenHolderChange\x12\x14\n" +
	"\x05token\x18\x01 \x01(\fR\x05token\x12!\n" +
	"\fholder_delta\x18\x02 \x01(\x05R\vholderDelta\"\xba\x02\n" +
	...
	"\vpre_balance\x18\b \x01(\tR\n" +
	"preBalance\x12!\n" +
	"\fpost_balance\x18\t \x01(\tR\vpostBalance\x12\x1a\n" +
	"\bdecimals\x18\n" +
	" \x01(\rR\bdecimals\"\xdc\n" +
	"\n" +
	"\fMigrateEvent\x12!\n" +
	"\x04type\x18\x01 \x01(\x0e2\r.pb.EventTypeR\x04type\x12\x19\n" +
	"\bevent_id\x18\x02 \x01(\x04R\aeventId\x12!\n" +
	...
	"\ftoken_amount\x18\r \x01(\tR\vtokenAmount\x12,\n" +
	"\x12quote_token_amount\x18\x0e \x01(\tR\x10quoteTokenAmount\x12#\n" +
	"\rmigration_fee\x18\x0f \x01(\tR\fmigrationFee\x12\x14\n" +
	...
	"\x16src_pair_token_balance\x18\x1d \x01(\tR\x13srcPairTokenBalance\x123\n" +
	"\x16src_pair_quote_balance\x18\x1e \x01(\tR\x13srcPairQuoteBalance\x125\n" +
	"\x17dest_pair_token_balance\x18\x1f \x01(\tR\x14destPairTokenBalance\x125\n" +
	"\x17dest_pair_quote_balance\x18  \x01(\tR\x14destPairQuoteBalance\"\x86\x04\n" +
	...
	"\x03dex\x18\n" +
	" \x01(\rR\x03dex\x12!\n" +
	"\ftotal_supply\x18\v \x01(\tR\vtotalSupply\x12\x14\n" +
	...
	"\aMIGRATE\x10\n" +
	"\x12\x13\n" +
	"\x0fLAUNCHPAD_TOKEN\x10\v\x12\x17\n" +
	"\x13TOKEN_HOLDER_CHANGE\x10\f\x12\x12\n" +
	"\x0eBALANCE_UPDATE\x10<B\x15Z\x13dex-stats-sol/pb;pbb\x06proto3"
...
var file_event_proto_goTypes = []any{
	...
	(*TokenHolderChangeEvent)(nil), // 11: pb.TokenHolderChangeEvent
	(*TokenHolderChange)(nil),      // 12: pb.TokenHolderChange
	(*BalanceUpdateEvent)(nil),     // 13: pb.BalanceUpdateEvent
	(*MigrateEvent)(nil),           // 14: pb.MigrateEvent
	(*LaunchpadTokenEvent)(nil),    // 15: pb.LaunchpadTokenEvent
}
var file_event_proto_depIdxs = []int32{
	...
	13, // 7: pb.Event.balance:type_name -> pb.BalanceUpdateEvent
	14, // 8: pb.Event.migrate:type_name -> pb.MigrateEvent
	15, // 9: pb.Event.token:type_name -> pb.LaunchpadTokenEvent
	11, // 10: pb.Event.holder_change:type_name -> pb.TokenHolderChangeEvent
	2,  // 11: pb.TradeEvent.type:type_name -> pb.EventType
	2,  // 12: pb.TransferEvent.type:type_name -> pb.EventType
	2,  // 13: pb.LiquidityEvent.type:type_name -> pb.EventType
	1,  // 14: pb.LiquidityEvent.token_program:type_name -> pb.TokenProgramType
	1,  // 15: pb.LiquidityEvent.quote_token_program:type_name -> pb.TokenProgramType
	2,  // 16: pb.MintToEvent.type:type_name -> pb.EventType
	2,  // 17: pb.BurnEvent.type:type_name -> pb.EventType
	2,  // 18: pb.TokenHolderChangeEvent.type:type_name -> pb.EventType
	12, // 19: pb.TokenHolderChangeEvent.holder_change:type_name -> pb.TokenHolderChange
	2,  // 20: pb.BalanceUpdateEvent.type:type_name -> pb.EventType
	2,  // 21: pb.MigrateEvent.type:type_name -> pb.EventType
	2,  // 22: pb.LaunchpadTokenEvent.type:type_name -> pb.EventType
	1,  // 23: pb.LaunchpadTokenEvent.token_program:type_name -> pb.TokenProgramType
